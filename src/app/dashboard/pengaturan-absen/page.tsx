          ...
          <CardContent className="space-y-6 p-4 sm:p-6">
            <div className="rounded-lg border p-4 space-y-4">
                ...
                <div className="space-y-4 pt-4 border-t">
                    ...
                    <p className="text-sm text-muted-foreground">Pilih hari dalam seminggu yang dianggap sebagai hari libur. Sistem absensi akan non-aktif pada hari-hari ini.</p>
