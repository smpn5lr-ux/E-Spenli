  ...
  return (
    ...
    <div className="space-y-6 pb-24">
        <div className="space-y-1">
            <h1 className="text-2xl font-semibold tracking-tight">Pengaturan Absensi Umum</h1>
            <p className="text-sm text-muted-foreground">Atur mode libur, validasi lokasi & jam kerja, serta parameter fundamental lainnya untuk sistem absensi.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
       ...
       <Card>
          <CardHeader className="p-4 sm:p-6"><CardTitle>QR Code Absensi</CardTitle><CardDescription>Gunakan QR Code ini untuk absensi. Pindahkan ke posisi akhir untuk keamanan.</CardDescription></CardHeader>
